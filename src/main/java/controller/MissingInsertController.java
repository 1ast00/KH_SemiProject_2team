...
public class MissingInsertController implements Controller {
    ...
    public ModelAndView execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String memberSerialNum = "MM10000001"; // 로그인 구현 전 임시
        ...
        try {
            ...
            if (adminSerialNum == null) throw new Exception("관리자 정보를 찾을 수 없습니다.");
            ...
            if (person != null) request.setAttribute("submittedData", person);
