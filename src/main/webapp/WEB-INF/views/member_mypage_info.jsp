...
<script
	src="${pageContext.request.contextPath}/resource/js/member_mypage_info.js"></script>
						...
						<div class="profile-info">
							...
							<div class="profile-details">
								<div class="detail-row">
									...
									<input type="text" class="detail-value" name="member_name"
										value="${member.member_name}" readonly />
								</div>
								<div class="detail-row">
									<div class="detail-label">전화번호</div>
									<input type="text" class="detail-value" name="member_phone"
								...
								<div class="detail-row">
									...
									<c:choose>
										<c:when test="${member.member_email == null}">
											<input type="text" class="detail-value" name="member_email"
												value="" readonly />
										</c:when>
										<c:otherwise>
											<input type="text" class="detail-value" name="member_email"
							...
							<input type="hidden" id="memberSerialNum"
								value="${member.member_serialNum}" />
