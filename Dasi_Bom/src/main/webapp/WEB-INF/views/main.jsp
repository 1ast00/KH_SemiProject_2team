...
<body>
    ...
    <jsp:include page="/WEB-INF/views/template/header.jsp" /> <section class="search-section">
        <div class="search-input-container" id="mainSearchContainer">
            ...
            <button id="searchButton"><img src="${pageContext.request.contextPath}/resources/img/search_icon.png" alt="검색"></button>
        </div>
        ...
        <div id="detailedSearchInputs" class="detailed-search-container">
            ...
            <button id="detailedSearchBtn"><img src="${pageContext.request.contextPath}/resources/img/search_icon.png" alt="상세 검색"></button>
        </div>
    </section>
            ...
            <div class="missing-cards-container">
                <div class="missing-person-card">
                    <a href="/missing-person/detail/1">
                        <img src="${pageContext.request.contextPath}/resources/img/person1.jpg" alt="김철수">
                ...
                <div class="missing-person-card">
                    <a href="/missing-person/detail/2">
                        <img src="${pageContext.request.contextPath}/resources/img/person2.jpg" alt="어린이">
                        <div class="person-info">
                            <p>이름 : 어린이</p>
                            <p>나이 : 7(실종당시)</p>
                            <p>실종장소 : xx동</p>
                ...
                <div class="missing-person-card">
                    <a href="/missing-person/detail/3">
                        <img src="${pageContext.request.contextPath}/resources/img/person3.jpg" alt="이순신">
                        <div class="person-info">
                            <p>이름 : 이순신</p>
                            <p>나이 : 27(실종당시)</p>
                            <p>실종장소 : GG동</p>
