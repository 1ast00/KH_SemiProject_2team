	...
	<section class="search-section">
		<div class="search-input-container" id="mainSearchContainer">
			<input type="text" id="mainSearchInput"
				placeholder="이름/나이/성별/실종장소를 입력해주세요">
			<button id="searchButton">
				<img
					src="${pageContext.request.contextPath}/resource/img/search_icon.png"
					alt="검색">
			</button>
		</div>
		...
		<div id="detailedSearchInputs" class="detailed-search-container">
			<input type="text" id="searchName" placeholder="이름"> <input
				type="text" id="searchAge" placeholder="나이"> <input
				type="text" id="searchGender" placeholder="성별"> <input
				type="text" id="searchLocation" placeholder="실종 위치"> <input
				type="text" id="searchOther" placeholder="기타">
				...
				<div class="missing-person-card">
					<a href="${pageContext.request.contextPath}/missingView.do?missingSerialNum=${person.missingSerialNum}" class="person-card-link">
						<div class="card-image">
							<!-- 이미지 경로 수정 [  ${pageContext.request.contextPath}  ]제거 -->
